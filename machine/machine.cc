...
//Jess add
unsigned FreePage::pop() { ASSERT(!empty()); return Array[begin++%numPages]; }
void FreePage::push(unsigned p) { ASSERT(!full()); Array[end++%numPages] = p; }
//Jess end
