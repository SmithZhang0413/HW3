...
// then, copy in the code and data segments into memory
	if (noffH.code.size > 0) {
        ...
        while(s > 0) {
            ...
            //cout<<"PageSize - va% PageSize"<<va% PageSize<<endl;
	        
            executable->ReadAt(tmp + va, remain, ia);
            s -= remain; va += remain; ia += remain;
            //cout<<"in code seg remain: "<<remain<<endl;
	     //cout<<"in code seg s: "<<s<<endl;  
        }
    }
	if (noffH.initData.size > 0) {
        ...
        while(s > 0)
        {
            ...
            va += remain; 
            ia += remain;
		//cout<<"in data seg remain: "<<remain<<endl;
	     //cout<<"in data seg s: "<<s<<endl;  
